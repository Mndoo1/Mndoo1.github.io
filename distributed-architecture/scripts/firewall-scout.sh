...
echo "=== Tailscale Firewall Setup for AWS 3 (Scout) ==="
echo ""
...
echo "[5/5] Allowing Browserless (3000) ONLY from Tailscale..."
iptables -A INPUT -i "$TAILSCALE_INTERFACE" -p tcp --dport 3000 -j ACCEPT
...
echo "Browserless (3000) is now ONLY accessible via Tailscale."
